      ...
      <div className="w-full max-w-sm rounded-2xl bg-white shadow-2xl overflow-hidden">
        ...
        <div className="flex items-start justify-between px-5 pt-5 pb-3">
          <div>
            ...
            <h2 className="mt-0.5 text-base font-semibold text-gray-900 capitalize">
              {ingredientName}
            </h2>
          </div>
          <button
            onClick={onClose}
            className="ml-4 flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors"
            aria-label="Close"
          >
            ✕
          </button>
          ...
          {substitutions.map((sub, i) => (
            ...
            >
              ...
              <button
                ...
                className="shrink-0 rounded-lg bg-orange-50 px-3 py-1.5 text-xs font-semibold text-orange-600 transition-colors hover:bg-orange-500 hover:text-white"
              >
                Replace
              </button>
            </div>
